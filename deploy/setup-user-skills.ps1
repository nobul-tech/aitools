...
Deploy-EmbeddedSkill "aitool-continue" $skillsDest "claude skills" $skill_aitool_continue
...
Deploy-EmbeddedSkill "aitool-continue" $skillsDestCursor "cursor skills" $skill_aitool_continue
