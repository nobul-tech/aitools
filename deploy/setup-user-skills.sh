...
cat > "$_skill_tmp/aitool-continue.md" <<'__SKILL_AITOOL_CONTINUE__'
---
...
deploy_embedded_skill "aitool-continue" "$SKILLS_DEST" "claude skills" "$_skill_tmp/aitool-continue.md"
...
deploy_embedded_skill "aitool-continue" "$SKILLS_DEST_CURSOR" "cursor skills" "$_skill_tmp/aitool-continue.md"
