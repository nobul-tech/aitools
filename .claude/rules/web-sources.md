...
- Reading official tool docs to extract install commands for `tool-install-sources.md`
...
Before reading a tool's docs, check `reference/tool-install-sources.md` first --
