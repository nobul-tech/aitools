...
| Item | Plan | Priority | Summary |
|------|------|----------|---------|
| Governance & compliance framework | plans/governance-and-compliance-framework.md | High | Three-layer governance (prevention/detection/audit), 41 skills (33 user + 8 project), gap governance (known-gaps.json), SubagentStart pre-built cache, PreToolUse validation hooks, SQLite telemetry + Datadog KPIs |
