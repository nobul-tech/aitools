...
| User repo & session archive | [plan](plans/user-repo-and-session-hooks.md) | High | Phase A implemented (macOS verified, Windows untested). Phase B pending (shared/ templatization). |
