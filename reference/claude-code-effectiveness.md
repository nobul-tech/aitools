...
| I9 | 2026-03-01 | Process | Unnecessary @import of reference/tool-ops-claude-code.md (formerly claude-code-maintenance.md) in CLAUDE.md -- added 85 lines of maintenance-only context to every session. File already triggered by post-push checklist #20. | RCA | -- | -- |
